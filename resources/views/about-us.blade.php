...
<div class="breadcrumb-section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="about-us-center-content text-center">
                        <h4 data-aos="fade-up"  data-aos-delay="0">Why Chose Us?</h4>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="testimonial-section section-top-gap-100">
        <div class="container">
            <div class="row">
                <h4 class="testimonial-title" data-aos="fade-up"  data-aos-delay="0">What Our Custumers Say ?</h4>
            </div>
            <div class="row">
                <div class="testimonial-slider fix-slider-dots testimonial-slider-dots" data-aos="fade-up"  data-aos-delay="200">
